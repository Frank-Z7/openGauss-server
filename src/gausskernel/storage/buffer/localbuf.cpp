...
static void InitLocalBuffers(void)
{
    ...
    u_sess->storage_cxt.LocalBufferDescriptors = (LocalBufferDescPadded*)MemoryContextAllocZero(
        SESS_GET_MEM_CXT_GROUP(MEMORY_CONTEXT_STORAGE), (unsigned int)nbufs * sizeof(LocalBufferDescPadded));
