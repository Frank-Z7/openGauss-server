...
extern bool _bt_checkkeys(
    IndexScanDesc scan, IndexTuple tuple, int tupnatts, ScanDirection dir, bool* continuescan);
extern bool _bt_check_rowcompare(ScanKey skey, IndexTuple tuple, int tupnatts, 
