...
extern void ComparePartitionValue(List* pos, FormData_pg_attribute* attrs, List *partitionList, bool isPartition = true);
extern void CompareListValue(const List* pos, FormData_pg_attribute* attrs, List *partitionList);
...
extern Const* GetPartitionValue(List* pos, FormData_pg_attribute* attrs, List* value, bool isinterval, bool isPartition);
